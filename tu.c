...
**
** 2/22/99 js
** fixed dumb but deadly bug in rsrlibc.c.  It involved confusing rf->rec_len_day with 
** rf->rec_n_day in rsr_next_record().  I'm not sure how tu could have worked properly
** at all with this bug in place.
**
** 2/20/2000 js
** fixed 2000 leap year problem in sunae.c
** v 1.2.912
**
** 8/9/2000 js
** changed the emit_header() routine to spit out hex values where it makes more sense
** i.e., flags, aux, all-the-time, etc.
** v 1.2.913
*/

#define VERSION "1.2.913"
